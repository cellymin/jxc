...
define ('ADMIN_URL' ,'http://www.testjxc.com/erp');
define('API_HOST','http://www.testjxc.com/api/Public/v1/');
define('API_PUBLIC','www.testjxc.com/api/Public/');


define ('OSA_DB_ID' ,'jxc');
